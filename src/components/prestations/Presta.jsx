      ...
      <section className="section-prestations">
         <div className="container pt-4">
            ...
            <div className="row my-4 prestation">
               <div className="col-lg-6 col-md-6" data-aos="fade-right" data-aos-duration="750" data-aos-once="true">
               ...
               <div className="col-lg-6 col-md-6">
                  <div className="pr-3 mb-5 mb-lg-0">
                     <div className="prestations-text" data-aos="fade-left" data-aos-duration="750" data-aos-once="true">
            ...
            <div className="row mb-4">
               <div className="col-lg-6 col-md-6">
                  <div className="pr-3 mb-5 mb-lg-0">
                     <div className="prestations-text" data-aos="fade-right" data-aos-duration="750" data-aos-once="true">
               ...
               <div className="col-lg-6 col-md-6">
                  <div className="prestations-images" data-aos="fade-left" data-aos-duration="750" data-aos-once="true">
            ...
            <div className="row mb-4 prestation">
               <div className="col-lg-6 col-md-6">
                  <div className="prestations-images" data-aos="fade-right" data-aos-duration="750" data-aos-once="true">
